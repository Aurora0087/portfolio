...
function ProjectModel({ modal, projects }: { modal: any, projects: any }) {
    ...
    return (
        <>
            <motion.div ref={modalContainer} variants={scaleAnimation} initial="initial" animate={active ? "enter" : "closed"} className="modalContainer rounded-2xl bg-red-700">
